...
parser.add_argument('dataset_folder', type=str, 
                   help='The sub-directory containing all the cfg files. ')
...
for evttype in args.evttypes:
  ...
  cfg_fname = args.dataset_folder + '/{0}{1}.cfg'.format(fname_prefix, evttype)
...
cfg_fname = args.dataset_folder + '/stacked_components.cfg'
with open(out_fname, 'w') as f: 
    subprocess.check_call(
