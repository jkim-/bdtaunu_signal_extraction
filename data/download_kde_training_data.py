...
if __name__ == '__main__':
    ...
    populate_sql_script_template = 'sql/download_training_data_template.sql'
    ...
    print "+ downloading...".format(args.evttype)
    sys.stdout.flush()

    start = time.time()
    temp = instantiate_tempfile(populate_sql_script_template, args.evttype)
    verbosity_flag = "-q"
    if args.verbose: 
        verbosity_flag = "-a"
